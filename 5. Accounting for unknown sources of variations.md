...
We can observe from the figure above that the RUVs method resulted in a better normalization of the counts metrices. We can see that not all normalization technique can result in a good/clear sample separation.
